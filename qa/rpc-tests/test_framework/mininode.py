# mininode.py - Phtevencoin P2P network half-a-node
#
...
#
# NodeConn: an object which manages p2p connectivity to a phtevencoin node
# NodeConnCB: a base class that describes the interface for receiving
#             callbacks with network messages from a NodeConn
# CBlock, CTransaction, CBlockHeader, CTxIn, CTxOut, etc....:
#     data structures that should map to corresponding structures in
#     phtevencoin/primitives
...
# Objects that map to phtevencoind objects, which can be serialized/deserialized
...
class msg_headers(object):
    ...
    def deserialize(self, f):
        # comment in phtevencoind indicates these should be deserialized as blocks
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest"):
        ...
        print 'MiniNode: Connecting to Phtevencoin Node IP # ' + dstaddr + ':' \
            + str(dstport)

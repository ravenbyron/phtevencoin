...
###   This script attempts to download the signature file SHA256SUMS.asc from phtevencoin.org
...
WORKINGDIR="/tmp/phtevencoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://phtevencoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://phtevencoin.org/bin/"
VERSIONPREFIX="phtevencoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'phtevencoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[phtevencoin-]<version>-[rc[0-9]] (example: phtevencoin-0.9.2-rc1)"
   echo "wget output:"

...
#ifndef PHTEVENCOIN_QT_WALLETMODEL_H
#define PHTEVENCOIN_QT_WALLETMODEL_H
...
/** Interface to Phtevencoin wallet from Qt view code. */
...
#endif // PHTEVENCOIN_QT_WALLETMODEL_H

...
#ifndef PHTEVENCOIN_QT_PHTEVENCOINUNITS_H
#define PHTEVENCOIN_QT_PHTEVENCOINUNITS_H
...
/** Phtevencoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PhtevencoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PhtevencoinUnits(QObject *parent);

    /** Phtevencoin units.
      @note Source: https://en.phtevencoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PHC,
...
typedef PhtevencoinUnits::Unit PhtevencoinUnit;

#endif // PHTEVENCOIN_QT_PHTEVENCOINUNITS_H

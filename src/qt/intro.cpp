...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/phtevencoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Phtevencoin Core"),
     ...
     * override -datadir in the phtevencoin.conf file in the default data directory
     * (to be consistent with phtevencoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())

...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CPhtevencoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CPhtevencoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CPhtevencoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CPhtevencoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CPhtevencoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CPhtevencoinAddress(arr[0].get_str()).Get() == demoAddress.Get());

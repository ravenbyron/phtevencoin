...
#define BOOST_TEST_MODULE Phtevencoin Test Suite

#include "test_phtevencoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_phtevencoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

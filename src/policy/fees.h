...
// Copyright (c) 2009-2015 The Phtevencoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
#ifndef PHTEVENCOIN_POLICYESTIMATOR_H
#define PHTEVENCOIN_POLICYESTIMATOR_H
...
#endif /*PHTEVENCOIN_POLICYESTIMATOR_H */

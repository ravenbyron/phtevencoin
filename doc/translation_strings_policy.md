...
This document provides guidelines for internationalization of the Phtevencoin Core software. 
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `phtevencoin_en.ts` remains unchanged.

Phtevencoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/phtevencoin/files/Phtevencoin/phtevencoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Phtevencoin
...
New/changed settings (command-line or phtevencoin.conf file)
--------------------------------------------------------

Phtevencoin Core version 0.9.2.1 is now available from:

  https://phtevencoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PHC to 0.01 PHC
...
- Fix "Start phtevencoin on system login"

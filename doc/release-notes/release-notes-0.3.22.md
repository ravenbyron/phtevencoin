Download URL: https://sourceforge.net/projects/phtevencoin/files/Phtevencoin/phtevencoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PHC fee schedule (users still pay 0.01 PHC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #phtevencoin00 - #phtevencoin99

Phtevencoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/phtevencoin/files/Phtevencoin/phtevencoin-0.5.4/
...
http://gitorious.org/phtevencoin/phtevencoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Phtevencoin-Qt notifications under Growl 1.3.
Increase required age of Phtevencoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPhtevencoin properly when installing Phtevencoin-Qt over it. (Windows)

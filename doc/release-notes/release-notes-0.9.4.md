Phtevencoin Core version 0.9.4 is now available from:

  https://phtevencoin.org/bin/0.9.4/
...
this update is incompatible with the Phtevencoin system and could lead to consensus
forks.

Phtevencoin Core released binaries from https://phtevencoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~phtevencoin/+archive/ubuntu/phtevencoin
- A third-party or self-compiled Phtevencoin Core

upgrade to Phtevencoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

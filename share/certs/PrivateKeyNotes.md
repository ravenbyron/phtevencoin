...
unlocked to sign the Phtevencoin-Qt.app bundle.
...
allowing somebody to distribute a Phtevencoin-Qt.app or phtevencoin-qt-setup.exe with a valid
...
that the phtevencoin-qt.exe file inside the installer had not been tampered with.
